...
public class Rasmus_CollisionGame_Assignment1 extends PApplet {
...
public void keyPressed() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Rasmus_CollisionGame_Assignment1" };
    if (passedArgs != null) {
